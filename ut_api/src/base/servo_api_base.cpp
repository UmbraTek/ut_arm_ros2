...
int ServoApiBase::get_temp_limit_(int id, int8_t* min, int8_t* max) {
  return get_reg_int8(id, min, max, reg_.TEMP_LIMIT);
}
int ServoApiBase::set_temp_limit_(int id, int8_t min, int8_t max) {
  return set_reg_int8(id, min, max, reg_.TEMP_LIMIT);
}
int ServoApiBase::get_volt_limit_(int id, uint8_t* min, uint8_t* max) {
  return get_reg_int8(id, min, max, reg_.VOLT_LIMIT);
}
int ServoApiBase::set_volt_limit_(int id, uint8_t min, uint8_t max) {
  return set_reg_int8(id, min, max, reg_.VOLT_LIMIT);
}
