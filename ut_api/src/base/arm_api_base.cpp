...
int ArmApiBase::moveto_cartesian_circle(float* pose1, float* pose2, float mvvelo, float mvacc, float mvtime,
                                        float percent) {
  float data[16];
...
int ArmApiBase::moveto_joint_circle(float* mvjoint1, float* mvjoint2, float mvvelo, float mvacc, float mvtime,
                                    float percent) {
...
int ArmApiBase::set_utrc_int8n_now(uint8_t line, uint8_t id, uint8_t reg, uint8_t* data, uint8_t tx_len) {
  ...
  uint8_t tx_data[256] = {line, id, reg, tx_len};
...
int ArmApiBase::set_pass_rs485_now(uint8_t line, uint8_t timeout_ms, uint8_t tx_len, uint8_t rx_len, uint8_t* tx_data,
  ...
  uint8_t temp[256] = {line, timeout_ms, tx_len, rx_len};
